...
from generator import Generator, SrcMemGenerator
...
def parse_config():
    ...
    # architecture
    parser.add_argument('--arch', type=str, choices=['vanilla', 'src_mem'], default='vanilla')
...
def main(args, local_rank):
    ...
    elif args.arch == 'src_mem':
        model = SrcMemGenerator(vocabs,
    ...
    if args.world_size > 1:
        set_seed(19931015 + dist.get_rank())
